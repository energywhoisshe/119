...
<br>
  ...
  ⎱ 해군아 클럽가자 ⎱
    ...
    아나운서는 매 행사마다 다 른 사람으로 교체되어 섭외되었고 그들은 대부분 여성이었다. 그들이 말하는 것들은 군대와 조국을 위하는 것들이지만, 
    정작 그들은 남성 위주의 해당 집단이 만들어 낸 한정된 역할에 끼워 맞추어진다는 것 또한 변함없었다.
    
    갑작스럽게 덧입혀진 군함의 날카로운 뱃고동 소리는 위협적으로 그의 말을 방해 하며, 점차 고조되는 타악 비트와 베이스 사운드는 긴장감을 안겨준다.
    그 사이에서 나의 입교 신고를 알리는 ‘이에 신고합니다’라는 음성은 변조되고 분해되어 곳곳에 녹아들어 있지만, 불연속성 때문에 간신히 발화되는 듯해 감상자는 그 뜻을 알기 어렵다. 
    하지만 곡 중반부(2’23”), 유일하게 정확하고도 또렷한 음성 으로 들리는 것은 고발로써의 나의 신고이다.
